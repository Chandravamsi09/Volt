...
export default function AnalyticsView13Page() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-bold text-white tracking-tight">Volt Analytics Engine — Module 13</h1>
          ...
          <table className="w-full text-left text-sm">
            ...
            <tbody className="divide-y divide-surface-border">
              <tr className="hover:bg-background/50">
                <td className="px-4 py-3 font-mono font-medium text-white">pl_13_000</td>
              ...
              <tr className="hover:bg-background/50">
                <td className="px-4 py-3 font-mono font-medium text-white">pl_13_001</td>
              ...
              <tr className="hover:bg-background/50">
                <td className="px-4 py-3 font-mono font-medium text-white">pl_13_002</td>
              ...
              <tr className="hover:bg-background/50">
                <td className="px-4 py-3 font-mono font-medium text-white">pl_13_003</td>
              ...
              <tr className="hover:bg-background/50">
                <td className="px-4 py-3 font-mono font-medium text-white">pl_13_004</td>
              ...
              <tr className="hover:bg-background/50">
                <td className="px-4 py-3 font-mono font-medium text-white">pl_13_005</td>
              ...
              <tr className="hover:bg-background/50">
                <td className="px-4 py-3 font-mono font-medium text-white">pl_13_006</td>
              ...
              <tr className="hover:bg-background/50">
                <td className="px-4 py-3 font-mono font-medium text-white">pl_13_007</td>
              ...
              <tr className="hover:bg-background/50">
                <td className="px-4 py-3 font-mono font-medium text-white">pl_13_008</td>
              ...
              <tr className="hover:bg-background/50">
                <td className="px-4 py-3 font-mono font-medium text-white">pl_13_009</td>
              ...
              <tr className="hover:bg-background/50">
                <td className="px-4 py-3 font-mono font-medium text-white">pl_13_010</td>
              ...
              <tr className="hover:bg-background/50">
                <td className="px-4 py-3 font-mono font-medium text-white">pl_13_011</td>
