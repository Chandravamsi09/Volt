...
export default function AnalyticsView14Page() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-bold text-white tracking-tight">Volt Analytics Engine — Module 14</h1>
          ...
          <table className="w-full text-left text-sm">
            ...
            <tbody className="divide-y divide-surface-border">
              <tr className="hover:bg-background/50">
                <td className="px-4 py-3 font-mono font-medium text-white">pl_14_000</td>
              ...
              <tr className="hover:bg-background/50">
                <td className="px-4 py-3 font-mono font-medium text-white">pl_14_001</td>
              ...
              <tr className="hover:bg-background/50">
                <td className="px-4 py-3 font-mono font-medium text-white">pl_14_002</td>
              ...
              <tr className="hover:bg-background/50">
                <td className="px-4 py-3 font-mono font-medium text-white">pl_14_003</td>
              ...
              <tr className="hover:bg-background/50">
                <td className="px-4 py-3 font-mono font-medium text-white">pl_14_004</td>
              ...
              <tr className="hover:bg-background/50">
                <td className="px-4 py-3 font-mono font-medium text-white">pl_14_005</td>
              ...
              <tr className="hover:bg-background/50">
                <td className="px-4 py-3 font-mono font-medium text-white">pl_14_006</td>
              ...
              <tr className="hover:bg-background/50">
                <td className="px-4 py-3 font-mono font-medium text-white">pl_14_007</td>
              ...
              <tr className="hover:bg-background/50">
                <td className="px-4 py-3 font-mono font-medium text-white">pl_14_008</td>
              ...
              <tr className="hover:bg-background/50">
                <td className="px-4 py-3 font-mono font-medium text-white">pl_14_009</td>
              ...
              <tr className="hover:bg-background/50">
                <td className="px-4 py-3 font-mono font-medium text-white">pl_14_010</td>
              ...
              <tr className="hover:bg-background/50">
                <td className="px-4 py-3 font-mono font-medium text-white">pl_14_011</td>
